...
public class LogAspect2 {
    ...
    //增强的声明
    @Before("com.yc.aspect.LogAspect2.AddAndUpdate()")//AddAndUpdate()也可以
    public void log(JoinPoint jp) {
        System.out.println("前置2增强");
        ...
        System.out.println("前置2增强结束");
    }

    @After("com.yc.aspect.LogAspect2.AddAndUpdate()")//AddAndUpdate()也可以
    public void bye() {
        System.out.println("后置2增强");
        System.out.println("bye2");
        System.out.println("后置2增强结束");
    }
